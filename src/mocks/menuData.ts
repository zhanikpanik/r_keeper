...
export const menuProducts: Record<string, Product[]> = {
  hot: [
    { id: 'h1',  categoryId: 'hot', name: 'Выгодная пара с барбекю', price: 230 },
    { id: 'h2',  categoryId: 'hot', name: 'Тройной барбекю',         price: 240 },
    { id: 'h3',  categoryId: 'hot', name: 'Три сыра',                price: 250 },
    { id: 'h4',  categoryId: 'hot', name: 'Карбонара',               price: 260 },
    { id: 'h5',  categoryId: 'hot', name: 'Курица гриль',            price: 270 },
    { id: 'h6',  categoryId: 'hot', name: 'Нарезка мясо',            price: 280 },
    { id: 'h7',  categoryId: 'hot', name: 'Цезарь с курицей',        price: 290 },
    { id: 'h8',  categoryId: 'hot', name: 'Мега Биф',                price: 300 },
    { id: 'h9',  categoryId: 'hot', name: 'Нарезка рыба',            price: 310 },
    { id: 'h10', categoryId: 'hot', name: 'Оливье',                  price: 320 },
    { id: 'h11', categoryId: 'hot', name: 'Биг Мак',                 price: 330 },
    { id: 'h12', categoryId: 'hot', name: 'Нарезка сыр',             price: 340 },
    { id: 'h13', categoryId: 'hot', name: 'Крабовый',                price: 350 },
    { id: 'h14', categoryId: 'hot', name: 'Шаурма',                  price: 360 },
  ],
  kids: [
  ...
  pizza: [
    { id: 'pz1', categoryId: 'pizza', name: 'Маргарита',     price: 350 },
    { id: 'pz2', categoryId: 'pizza', name: 'Пепперони',     price: 400 },
    { id: 'pz3', categoryId: 'pizza', name: '4 сыра',        price: 420 },
    { id: 'pz4', categoryId: 'pizza', name: 'Гавайская',     price: 380 },
    { id: 'pz5', categoryId: 'pizza', name: 'Карбонара',     price: 430 },
    { id: 'pz6', categoryId: 'pizza', name: 'Мясная',        price: 450 },
  ],
  shashlik: [
